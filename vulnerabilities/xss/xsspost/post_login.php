...
if(isset($_POST['submit'])){
    if($_POST['username']!=null && $_POST['password']!=null){
        ...
        if(mysqli_num_rows($result)==1){
            ...
            skip('登录成功，欢迎进入', 'xss_reflected_post.php');
        }else{
            skip('登录失败，请重试', 'post_login.php');
        }
    }  
}
...
<div id="left_bar">
    ...
    <ul class="left_list">
        ...
        <li><a href="post_login.php">反射型XSS(post)</a></li>
...
<div id="idu_login_main">
	<p class="tips">测试账号：kobe/123456</p>
...
<div id="right_bar">
	<p class="tips">tips:<br />post方式？是否可以自造表单进行提交？<br />试试看！</p>
</div>
