...
<div id="left_bar">
    ...
    <ul class="left_list">
        ...
        <li><a href="csrfpost/csrf_login.php">CSRF(post)</a></li>
...
很多人搞不清楚CSRF的概念，甚至有时候会将其和XSS混淆。这里列举一个场景解释一下，希望能够帮助你理解。<br />
...
于是他自己跑到www.xx.com上注册了一个自己的账号，然后修改了一下个人信息（比如：E-mail地址），他发现修改的请求是：<br />
